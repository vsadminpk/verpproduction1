...
function setup_search_params() {
    ...
    let meeting_with = search_params.get("Meeting with")
    ...
    if(meeting_with) {
        let meeting_with_input = document.getElementById("meeting_with");
        meeting_with_input.value = meeting_with;
        meeting_with_input.disabled = true;
    }
}
